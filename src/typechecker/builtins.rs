...
impl TypeChecker {
    pub(super) fn register_builtins(&mut self, env: &mut TypeEnv) {
        ...
        //
        // These sentinels must NOT collide with IDs generated by the
        // type-variable counter used for user-defined enums. This is safe
        // today because user-defined enums allocate IDs via `fresh_var()`,
        // which starts well above 0. If the allocation scheme ever changes,
        // these sentinels must be revisited.
        // ──────────────────────────────────────────────────────────────────
        self.enums.insert(
            intern("Option"),
            EnumInfo {
